...
import info.imtushar.image_cropper.R;
...
//    private ImageCropperListener mImageCropperListener;
...
/*    public void setImageCropperListener(ImageCropperListener listener){
        mImageCropperListener = listener;
    }*/
...
/*
        ImageCropperListener imageCropperListener = mImageCropperListener;

        if (imageCropperListener != null){
            imageCropperListener.imageCropperAction(result.uri);
        }*/

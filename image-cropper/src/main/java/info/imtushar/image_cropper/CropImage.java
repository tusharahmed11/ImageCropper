...
public final class CropImage {
    ...
    public static final class ActivityBuilder implements CropImageView.OnCropImageCompleteListener{
        ...
        private CropImageView.CropResult cropResult;
         ...
         */
        public void start(@NonNull Activity activity, ActivityResultLauncher<Intent> startForResult) {
            mOptions.validate();
            //activity.startActivityForResult(getIntent(activity), CROP_IMAGE_ACTIVITY_REQUEST_CODE);
           // activity.getStartForResult().launch(getIntent(activity));
            startForResult.launch(getIntent(activity));
          /*  MainActivity.Companion.getInstanceActivity().getStartForResult().launch(getIntent(activity));
            imageCropperListener.intentAction(getIntent(activity));*/
//            imageCropperListener.intentAction(getCropResult());
        }


        public CropImageView.CropResult getCropResult() {
            return cropResult;
        }

        public void setCropResult(CropImageView.CropResult cropResult) {
